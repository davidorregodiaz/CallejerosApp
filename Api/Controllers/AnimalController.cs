...
public class AnimalsController : ControllerBase
{
    ...
    public AnimalsController(IAnimalService animalService, IWebHostEnvironment webHostEnvironment)
    {
    ...
    public async Task<IResult> CreateAnimal([FromForm] string animalData,[FromForm] IEnumerable<IFormFile> Images)
    {
        ...
        var uploadDir = Path.Combine("wwwroot","images", "upload");
        ...
        var createAnimalResult = await _animalService.CreateAnimal(createAnimalDto,picturesPaths);
