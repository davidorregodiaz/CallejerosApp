...
namespace Infraestructure.Migrations
{
    ...
    public partial class AddAnimals : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "animal_requierements",
                columns: table => new
                {
                    animal_id = table.Column<Guid>(type: "uuid", nullable: false),
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    requierement = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_animal_requierements", x => new { x.animal_id, x.Id });
                    table.ForeignKey(
                        name: "FK_animal_requierements_animals_animal_id",
